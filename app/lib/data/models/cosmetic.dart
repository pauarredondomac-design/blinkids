...
extension CosmeticSlotX on CosmeticSlot {
  ...
  bool get isRequired =>
      this == CosmeticSlot.top || this == CosmeticSlot.bottom;
...
CosmeticSlot cosmeticSlotFromString(String s) => CosmeticSlot.values
    .firstWhere((e) => e.name == s, orElse: () => CosmeticSlot.helmet);
